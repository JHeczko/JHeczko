...
Implementation of a GPT-2 style transformer model trained on Shakespeare dataset.  
Includes custom transformer blocks, autoregressive training loop, tokenization pipeline and text generation.
